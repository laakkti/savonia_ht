    ...
    private class ReadMessageTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                String query = "label:inbox from:gtw.mob@gmail.com is:unread"; // maxResults:4";
                //String query = "label:inbox from:laakkti@gmail.com is:unread"; // maxResults:4";
                //String query = "maxResults:4";
                Log.v("xxx",query);
                if(mService==null){

                    Log.v("xxx","mService=null");
                }

                List<Message> messages = listMessagesMatchingQuery(mService, "gtw.mob@gmail.com", query, (long) 1);
...
//		System.out.println(message.toPrettyString());
        ...
        public List<Message> listMessagesMatchingQuery(Gmail service, String userId,
            ...
            Log.v("xxx",response.toString());
            Log.v("xxx",response.getMessages().toString());
